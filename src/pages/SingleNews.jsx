    ...
    <>
      ...
      <div className='news-text-area'>
        <div className='news-text'>
          <p>{`Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi quia, ipsa inventore nemo error blanditiis atque aperiam voluptatem? Sit est quibusdam recusandae! Quas officiis officia maiores quibusdam animi, quis atque.
